  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <form method="post" action="submit_repair.php" enctype="multipart/form-data">

        <div class="form-group">
          <label for="reporter">ผู้แจ้งซ่อม:</label>
          <input type="text" id="reporter" name="reporter" class="form-control" value="<?= $_SESSION['name'] . ' ' . $_SESSION['surname'] ?>" readonly>
        ...
        <textarea id="description" name="description" rows="3" cols="50" class="form-control" required></textarea><br>
        </div>

        <input class="btn btn-primary my-2" type="submit" value="ส่งคำร้อง">
        </form>
        </div>
        <!--จบเนื้อหา-->
